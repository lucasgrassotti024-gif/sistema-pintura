...
export function ActivityList({ activities = [], onSelectActivity }: ActivityListProps) {
  if (activities.length === 0) {
    return (
      <div className="p-8 sm:p-12 text-center text-slate-400 border border-white/5 rounded-lg bg-[#0f172a]/40 backdrop-blur-xs">
  ...
  return (
    <div className="space-y-3">
        ...
        {activities.map((activity) => {
          ...
          return (
            <div
              ...
              className={`p-4 rounded-lg border bg-[#0f172a] shadow-sm active:bg-white/5 transition-all cursor-pointer space-y-3 ${
                delayed
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-2 text-xs text-slate-300 pt-1 border-t border-white/5">
                <span className="bg-[#090d16] px-2 py-0.5 rounded border border-white/5 text-[11px] text-slate-300 font-medium">
                  {activity.location.area}
                </span>
                <span className="bg-[#090d16] px-2 py-0.5 rounded border border-white/5 font-mono text-[11px] text-emerald-400">
      ...
      <div className="hidden md:block overflow-x-auto border border-white/5 rounded-lg bg-[#0f172a] shadow-sm">
