    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
      ...
      <div className="bg-[#0c1524] border border-blue-500/15 rounded-lg p-3.5 shadow-sm space-y-1">
        ...
        <div className="flex items-baseline gap-1.5">
          ...
          <span className="text-[10px] text-blue-400 font-mono">itens</span>
        </div>
      </div>

      {/* 2. Materiais em Risco */}
      <div className="bg-[#0c1524] border border-amber-500/25 bg-amber-500/5 rounded-lg p-3.5 shadow-sm space-y-1">
      ...
      <div className="bg-[#0c1524] border border-rose-500/25 bg-rose-500/5 rounded-lg p-3.5 shadow-sm space-y-1">
      ...
      <div className="bg-[#0c1524] border border-blue-500/15 rounded-lg p-3.5 shadow-sm space-y-1 col-span-2 sm:col-span-1">
        <span className="text-[11px] font-mono text-slate-400 uppercase tracking-wider block">
          Volume Consumido
        </span>
        <div className="flex items-baseline gap-1.5">
