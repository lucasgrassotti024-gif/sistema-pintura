...
export function MaterialForm({ initialMaterial, onSave, onCancel }: MaterialFormProps) {
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-lg p-6 max-w-2xl w-full space-y-6 shadow-sm">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 text-xs">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-white text-slate-900 border border-slate-300 rounded px-3 py-2 focus:ring-1 focus:ring-blue-600 focus:outline-hidden font-mono uppercase"
              required
            />
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div>
            <label className="block font-semibold text-slate-700 mb-1">Tipo / Família *</label>
            <select
              value={type}
            ...
            {type === "Outro" && (
              <input
                ...
                className="w-full mt-2 bg-white text-slate-900 border border-slate-300 rounded px-3 py-1.5 focus:ring-1 focus:ring-blue-600 focus:outline-hidden"
                required
              />
            )}
          </div>
          ...
          <div>
            <label className="block font-semibold text-slate-700 mb-1">Fabricante</label>
            <input
              type="text"
              value={manufacturer}
          ...
          <div>
            <label className="block font-semibold text-slate-700 mb-1">Cor / Padrão</label>
            <input
              type="text"
              value={color}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block font-semibold text-slate-700 mb-1">Localização no Almoxarifado</label>
            <select
              value={location}
